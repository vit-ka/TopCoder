...
public class TreesAnalysisTest {
	
	@Test(timeout=2000)
	public void test0() {
		int[] tree1 = new int[] {1};
		int[] tree2 = new int[] {1};
		assertEquals(1L, new TreesAnalysis().treeSimilarity(tree1, tree2));
	}
	
	@Test(timeout=2000)
	public void test1() {
		int[] tree1 = new int[] {2, 4, 1, 0};
		int[] tree2 = new int[] {1, 4, 4, 4};
		assertEquals(111L, new TreesAnalysis().treeSimilarity(tree1, tree2));
	}
	
	@Test(timeout=2000)
	public void test2() {
		int[] tree1 = new int[] {1, 2, 3, 4};
		int[] tree2 = new int[] {1, 2, 3, 4}
;
		assertEquals(128L, new TreesAnalysis().treeSimilarity(tree1, tree2));
	}
	
	@Test(timeout=2000)
	public void test3() {
		int[] tree1 = new int[] {2, 3, 4, 4, 5, 8, 5, 6, 10, 8};
		int[] tree2 = new int[] {9, 0, 1, 0, 3, 0, 5, 0, 7, 10};
		assertEquals(6306L, new TreesAnalysis().treeSimilarity(tree1, tree2));
	}
	
	@Test(timeout=2000)
	public void test4() {
		int[] tree1 = new int[] {222, 261, 167, 133, 174, 150, 165, 311, 208, 268, 111, 222, 154, 277, 282, 201, 46, 124, 194, 331, 4, 216, 111, 
...
125, 164, 127, 179, 267, 221, 49, 139, 1, 84, 136, 38, 6, 70, 246, 243, 3, 188, 297};
		int[] tree2 = new int[] {174, 262, 195, 288, 157, 278, 36, 133, 230, 273, 222, 138, 97, 23, 189, 141, 296, 55, 45, 301, 81, 199, 188, 289, 
...
269, 29, 120, 259, 324, 328, 23, 243, 9, 61, 14, 118, 199, 146, 237, 14};
		assertEquals(11478648052L, new TreesAnalysis().treeSimilarity(tree1, tree2));
	}
}
